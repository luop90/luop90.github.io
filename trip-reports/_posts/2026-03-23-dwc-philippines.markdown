---
layout: post
title:  "A Week in the Philippines with DWC"
tags: "trip report"
...
1. Sand and paint the concrete walls
1. Install ceiling lights and wall fans
...
{% include figure_image.html
    image="putting-on-a-ceiling-tile.JPEG"
%}

{% include figure_image.html
    image="work-photo-2.JPG"
    caption="'Use your head!' was a common joke while installing ceiling tiles"
%}

{% include figure_image.html
    image="work-photo-1.JPG"
%}

{% include figure_image.html
    image="ceiling-tile-selfie.JPEG"
%}
...
<!-- <photo of Tata trimming one with his hand saw> -->
{% include figure_image.html
    image="tata-saws-by-hand.JPEG"
    caption="As we were warned, the local foreman won't really care for much PPE"
%}
...
{% include figure_image.html
    image="applying-putty.JPG"
    caption="Filling the cracks between the ceiling tiles"
%}

{% include figure_image.html
    image="sanding-sanding-sanding.JPG"
    caption="Sanding down the putty to be smooth"
%}
...
<!-- There were only a few items the school was missing compared to the US:
1. Running water
    * Instead, they collected rainwater in a cistern and manually hauled barrels of it to the bathroom, sinks, etc. 

1. A playground
    * This shocked me, and it seemed entirely a function of the school's grounds being quite small and therefore filled almost exclusively with classroom buildings rather than any sort of playground.
    * During their lunch break the kids would primarily race, play tag, etc. in the little bit of open space they had between buildings.

1. Computer lab
    * Given the school had reliable electricity, this was quite surprising, especially since the Sri Lanka school did have a computer lab (with various asterisks, such as a couple of their computers were broken, electricity wasn't reliable, etc.)
    * I had meant to ask the school's principal about this but never got the chance to. I'm guessing it was from a lack of space and/or the school only being an elementary school, so maybe the Jr and Sr. High schools had one?
    * But even then, I remember learning to type in 3rd and 4th grade, with full-on computer classes by 5th, so I think this is a pretty huge gap. -->
...
{% include figure_image.html
    image="hand-clap-game.JPG"
%}

<figure style="text-align: center;">
  <video controls playsinline style="max-width: 75%; height: auto;">
    <source src="{{ page.assets_path }}/flower-circle-game.mp4" type="video/mp4">
...
{% include figure_image.html
    ...
    caption="I haven't touched a basketball in <i>years</i> <br>...but being a foot taller than the competition can make up for a lot of flaws"
%}

<!-- And of course, there was the Sunday before we started the volunteer work where we explored the more touristy side of the island. Canyoning in Badian and seeing the sardine run by Moalboal was well worth the 2+ hour drive to get there.
...
{% include figure_image.html
    image="sunset-at-the-hotel.JPEG"
%}
